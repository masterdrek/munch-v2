...
public class SceneController
{
   ...
   public static void switchToHome(ActionEvent event) throws IOException {
    ...
    public static void switchToRestaurant(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(MunchApp.class.getResource("Restaurant.fxml"));
        scene = new Scene(root);
        stage.setScene(scene);
        stage.show();
    }
    public static void switchToAddReview(ActionEvent event) throws IOException {
        Parent root = FXMLLoader.load(MunchApp.class.getResource("AddReview.fxml"));
        scene = new Scene(root);
        stage.setScene(scene);
        stage.show();
    }
